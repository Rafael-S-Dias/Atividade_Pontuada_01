...
@pytest.fixture
def fisica_valida():
    pessoa_fisica1 = Fisica(222, "Rafael", "71988...", "Rafael@...", Sexo.MASCULINO, EstadoCivil.SOLTEIRO, "02/08/2001", Endereco("Rua A", 444, "Qd 10 Lt 7", "41.....", "Salvador", UnidadeFederativa.BAHIA) )
...
def test_data_de_nascimento_valido(fisica_valida):
    assert fisica_valida.datanascimento == "02/08/2001"
...
def test_data_de_nascimento_tipo_invalido():
    with pytest.raises(TypeError, match = "A data de nascimento deve ser um texto!"):
        Fisica(222, "Rafael", "71988...", "Rafael@...", Sexo.MASCULINO, EstadoCivil.SOLTEIRO, 02/08/2001, Endereco("Rua A", 444, "Qd 10 Lt 7", "41.....", "Salvador", UnidadeFederativa.BAHIA) )