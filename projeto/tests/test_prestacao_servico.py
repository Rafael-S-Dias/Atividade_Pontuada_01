...
def prestacao_de_servico_valida():
    prestacao_servico1 = PrestacaoServico(222, "Rafael", "71988...", "Rafael@...", "45800...", "5555", "01/08/2019", "30/09/2024", Endereco("Rua A", 444, "Qd 10 Lt 7", "41.....", "Salvador", UnidadeFederativa.BAHIA))
    return prestacao_servico1

def test_contrato_inicio_valido(prestacao_de_servico_valida):
    assert prestacao_de_servico_valida.contratoinicio == "01/08/2019"
...
def test_pessoa_contrato_inicio_invalido():
    with pytest.raises(TypeError, match = "O inicio de contrato deve ser um texto!"):
        PrestacaoServico(222, "Rafael", "71988...", "Rafael@...", "45800...", "5555", 01/08/2019, "30/09/2024", Endereco("Rua A", 444, "Qd 10 Lt 7", "41.....", "Salvador", UnidadeFederativa.BAHIA))
